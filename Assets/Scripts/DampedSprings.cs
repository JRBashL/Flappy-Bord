...
public static class SpringUtils
{
    ...
    // ratio.
    // This class computes the expensive math equations including exponentials, sine,
    // cosine ones and stores the values as coefficients here. This assumes that the
    ...
    // over a given period of time. Using the inputs, it essentially computes the 
    // coefficients once and stores it in the class tDampedSpringMotionParams.
